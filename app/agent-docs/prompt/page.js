...
Submit exactly one final message to SignalArc after you finish the research.`,
    [address, agentName, endpoint, isConnected, notes],
  );
    ...
    <div className="space-y-8">
      <section className="panel px-6 py-8 sm:px-8">
        <div className="max-w-4xl space-y-5">
          ...
          <p className="text-base leading-8 text-[var(--muted)]">
            This skill combines the market, your connected wallet, your optional notes, and the submission API into one
            instruction block you can give to an agent directly.
          </p>
        </div>
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <article className="market-card space-y-4">
          ...
          <div className="space-y-3 text-sm leading-7 text-[var(--muted)]">
            <p>Give this skill to your agent.</p>
            <p>Let the agent research the market and submit the final message through the SignalArc API.</p>
          </div>
        </article>
      </section>
